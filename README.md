...
This repository contains the [Apteligent](https://www.apteligent.com/) (formerly Crittercism) integration for the [mParticle Android SDK](https://github.com/mParticle/mparticle-android-sdk). 
